...
powershell -ExecutionPolicy Bypass -File .\scripts\check-rel-001.ps1
powershell -ExecutionPolicy Bypass -File .\scripts\check-doc-001.ps1
```

Related evidence documents:

- `docs/ai-context/build-commands.md`
- `docs/ai-context/repository-paging-tests.md`
- `docs/ai-context/mapper-field-tests.md`
- `docs/ai-context/ui-state-matrix.md`
- `docs/ai-context/scroll-performance-evidence.md`
- `docs/ai-context/ui-main-flow-release-evidence.md`
- `docs/ai-context/sdk-adapter-evidence.md`
