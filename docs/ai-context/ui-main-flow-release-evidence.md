...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\check-ui-001.ps1
powershell -ExecutionPolicy Bypass -File .\scripts\check-ui-002.ps1
powershell -ExecutionPolicy Bypass -File .\scripts\check-ui-003.ps1
powershell -ExecutionPolicy Bypass -File .\scripts\check-msg-006.ps1
powershell -ExecutionPolicy Bypass -File .\scripts\check-mail-006.ps1
...
powershell -ExecutionPolicy Bypass -File .\scripts\check-test-003.ps1
