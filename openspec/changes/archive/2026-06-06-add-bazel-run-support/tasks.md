...
- [x] BZL-RUN-006 在 `scripts/commands/ide-build.ps1` 中新增 `run-app` 或等价 target。
...
- [x] BZL-RUN-012 更新 `docs/ai-context/build-system/build-commands.md`，记录 run 命令和证据。
- [x] BZL-RUN-013 更新 `docs/ai-context/build-system/ide-bazel-workflow.md`，记录 run 用法。
- [x] BZL-RUN-014 遇到运行专属失败时，更新 `docs/ai-context/build-system/common-build-errors.md`。
